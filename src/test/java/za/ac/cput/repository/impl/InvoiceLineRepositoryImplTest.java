...
class InvoiceLineRepositoryImplTest {
    ...
    private static InvoiceLine invoiceLine = InvoiceLineFactory.buildInvoiceLine(addToList());
    ...
    @Test
    void b_read() {
        InvoiceLine readInvoiceLine = InvoiceLineRepository.read(invoiceLine.getInvoiceListID());
    ...
    @Test
    void d_delete() {
        boolean success = InvoiceLineRepository.delete(invoiceLine.getInvoiceListID());
        assertTrue(success);
